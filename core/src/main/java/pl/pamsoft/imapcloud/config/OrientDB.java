...
import static pl.pamsoft.imapcloud.config.GraphProperties.FILE_CHUNK_ENCRYPTED_SIZE;
...
import static pl.pamsoft.imapcloud.config.GraphProperties.FILE_CHUNK_ORG_SIZE;
...
public class OrientDB {
	...
	private void configGraphDb() {
		...
		if (tx.getVertexType(FileChunk.class.getSimpleName()) == null) {
			...
			vertexType.createProperty(FILE_CHUNK_ORG_SIZE, OType.LONG);
			vertexType.createProperty(FILE_CHUNK_ENCRYPTED_SIZE, OType.LONG);
