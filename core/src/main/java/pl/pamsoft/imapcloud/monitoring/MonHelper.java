...
public class MonHelper {
	...
	public static final List<MonKey> ALL_KEYS = Arrays.asList(
		EXECUTOR_ACTIVE, EXECUTOR_QUEUE, IMAP_THROUGHPUT,
		UL_DIRECTORY_SIZE_CALC, UL_DIRECTORY_PROCESSOR, UL_FILE_HASHER, UL_FILE_CHUNK_CREATOR, UL_CHUNK_HASHER, UL_CHUNK_ENCRYPTER, UL_CHUNK_SAVER,
		DL_CHUNK_LOADER, DL_CHUNK_DECRYPTER, DL_CHUNK_HASHER, DL_CHINK_APPENDER, DL_FILE_HASHER,
		VR_CHUNK_VERIFIER,
		RE_CHUNK_RECOVERY,
		DE_FILE_DELETER
	);
...
//				JAMonArrayBufferListener listener = new JAMonArrayBufferListener(i.getLabel(), list);
