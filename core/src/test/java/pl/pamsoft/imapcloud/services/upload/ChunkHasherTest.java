...
public class ChunkHasherTest {
	...
	public void shouldCalculateSha512Hash() throws Exception {
		...
		UploadChunkContainer uploadChunkContainer = UploadChunkContainer.addChunk(new UploadChunkContainer("testId", mockedFileDto), test.getBytes().length, 0, test.getBytes(), 1);
