...
public class AccountInfoSerializationBackendClientTest {
	...
	public void shouldSerialize() throws JsonProcessingException {
		...
		AccountInfo accountInfo = new AccountInfo("test", 1, 3, 2, of("test1", "testVal"));
		String expected = "{\"host\":\"test\",\"accountSizeMB\":3,\"maxFileSizeMB\":2,\"maxConcurrentConnections\":1,\"additionalProperties\":{\"test1\":\"testVal\"}}";
	...
	public void shouldDeserialize() throws IOException {
		ObjectMapper mapper = MapperHolder.OBJECT_MAPPER;
		String example = "{\"host\":\"test\",\"accountSizeMB\":3,\"maxFileSizeMB\":2,\"maxConcurrentConnections\":1,\"additionalProperties\":{\"test1\":\"testVal\"}}";
